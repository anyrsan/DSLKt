...
import com.any.org.onemodule.nviewmodel.NQtViewModel
 ...
 * @details 问答
 */
class NDetailsQTFragment : NDetailsFragment() {
    ...
    // 根据不同的
    private val detailVM: NQtViewModel by viewModel()
